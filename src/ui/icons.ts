export const ICONS = {
    ...
    volumeLow: '<path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z"/>',
    ...
    forward: '<path d="M4 5v14l8-7-8-7Zm9 0v14l8-7-8-7Z"/>',
    back: '<path d="M20 5v14l-8-7 8-7Zm-9 0v14L3 12l8-7Z"/>',
    boost: '<path d="M12 2l4 8H8l4-8Zm0 20l-4-8h8l-4 8Z"/>',
    menuArrow: '<path d="M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.41z"/>',
    menuBack: '<path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/>',
